...
export async function getAiPlatformAccess(id) { return unwrap(await apiGet(`/admin/users/${encodeURIComponent(id)}/ai-platform-access`, { _ts: Date.now() })); }
export async function updateAiPlatformAccess(id, payload = {}) { return unwrap(await apiPut(`/admin/users/${encodeURIComponent(id)}/ai-platform-access`, payload)); }
