      ...
      return (
        <div className="content-card module-error-card">
          ...
          <button
            ...
            onClick={() => this.setState((current) => ({ error: null, recoveryKey: current.recoveryKey + 1 }))}
          >
            Tekrar Dene
          </button>
        </div>
...
export default function AppV3() {
  ...
  useEffect(() => {
    ...
    if (
      normalized.moduleKey !== workspace.activeRoute.moduleKey ||
      normalized.tabKey !== workspace.activeRoute.tabKey
    ) {
