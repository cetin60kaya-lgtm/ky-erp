...
export function FirmCardExtras({ activeMainCompany, refreshKey, reloadAll, goTab }) {
...
export default function MuhasebeLegacyWorkspaces({
  activeTab,
  activeMainCompany,
  openModule,
}) {
...
export function ManagementSummary({ activeMainCompany, refreshKey, goTab }) {
...
export function CariMovements({ activeMainCompany, refreshKey, reloadAll }) {
...
export function KdvControl({ activeMainCompany, refreshKey }) {
  const now = new Date();
...
export function CheckPayment({ activeMainCompany, refreshKey, reloadAll }) {
  return (
    <CekOdemeMerkeziPage
      activeMainCompany={activeMainCompany}
      refreshKey={refreshKey}
...
export function MailExtract({ activeMainCompany, refreshKey, goTab }) {
  const state = useEndpoint(
    "/api/mail-tracking",
    activeMainCompany,
    refreshKey,
...
export function CompanyCards({ activeMainCompany, refreshKey, reloadAll }) {
  const [filters, setFilters] = useState({
    search: "",
    firmType: "",
    officialType: "",
...
export function ProfitLossCenter({ activeMainCompany, goTab }) {
  return (
...
export function Reports({ activeMainCompany, goTab }) {
  return (
...
export const muhasebeLegacyStyles = `
.muhasebe-workbench {
  --mh-blue: #0e63d8;
  --mh-dark: #07172d;
  --mh-border: #d7e1ef;
