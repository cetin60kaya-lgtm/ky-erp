...
export default function MuhasebePage({ activeTab, activeMainCompany, openModule }) {
  ...
  else if (current.key === "cek-odeme") content = <><CekOdemeMerkeziPage activeMainCompany={activeMainCompany} refreshKey={refreshKey} reloadAll={reloadAll} /><PaymentPlannerPanel activeMainCompany={activeMainCompany} /></>;
