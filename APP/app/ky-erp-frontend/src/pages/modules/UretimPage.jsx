import { CircleAlert, ClipboardList, Factory, Gauge, Settings, Zap } from "lucide-react";
...
function CompanyPending() {
  return (
    <div className="imalat-entry-page">
      <section className="iw-card production-page-intro">
        <div>
          <h1><CircleAlert size={21} /> Ana firma hazırlanıyor</h1>
          <p>Üretim ekranı tek model, irsaliye ve canlı veri bağlantısını kurmak için aktif firma bilgisini bekliyor.</p>
        </div>
        <span className="production-page-intro-badge"><Gauge size={15} /> Güvenli bekleme</span>
      </section>
    </div>
  );
}
