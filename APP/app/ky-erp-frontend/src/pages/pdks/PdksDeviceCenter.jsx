...
const online=(value)=>value&&Date.now()-new Date(value).getTime()<5*60*1000;
...
export default function PdksDeviceCenter({ activeTab="cihaz-baglantilari", activeMainCompany, isAuditAccount=false }){
  ...
  const load=useCallback(async()=>{
    if(isAuditAccount){setMessage("Denetim profili cihaz yönetiminde salt okunurdur.");return;}
    setBusy(true);
    try{
      ...
      setMessage("Cihaz ve senkronizasyon bilgileri güncel.");
