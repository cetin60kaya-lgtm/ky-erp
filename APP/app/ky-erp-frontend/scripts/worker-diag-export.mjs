...
const files = ["accounting-canonical-read.ts","accounting-dispatch-control-canonical.ts","accounting-document-archive.ts","accounting-document-intelligence.ts"];
...
console.log("WORKER_PARSE_GROUP_A1A_PASS");
`);
