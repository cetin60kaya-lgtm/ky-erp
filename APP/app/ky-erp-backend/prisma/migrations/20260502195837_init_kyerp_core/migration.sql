...
CREATE TABLE "vat_records" (
    ...
    "incoming_vat" DECIMAL(18,4) NOT NULL DEFAULT 0,
    "outgoing_vat" DECIMAL(18,4) NOT NULL DEFAULT 0,
    "carry_vat" DECIMAL(18,4) NOT NULL DEFAULT 0,
    "raw" JSONB,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "current_account_movements_main_company_slug_movement_date_idx" ON "current_account_movements"("main_company_slug", "movement_date");

-- CreateIndex
CREATE INDEX "current_account_movements_company_id_movement_date_idx" ON "current_account_movements"("company_id", "movement_date");

-- CreateIndex
CREATE INDEX "current_account_movements_main_company_slug_company_id_move_idx" ON "current_account_movements"("main_company_slug", "company_id", "movement_date");

-- CreateIndex
CREATE INDEX "current_account_movements_main_company_slug_document_no_idx" ON "current_account_movements"("main_company_slug", "document_no");
...
-- CreateIndex
CREATE INDEX "vat_records_main_company_slug_idx" ON "vat_records"("main_company_slug");

-- CreateIndex
CREATE INDEX "vat_records_main_company_slug_period_year_period_month_idx" ON "vat_records"("main_company_slug", "period_year", "period_month");

-- CreateIndex
CREATE INDEX "products_main_company_slug_idx" ON "products"("main_company_slug");

-- CreateIndex
CREATE INDEX "products_main_company_slug_normalized_name_idx" ON "products"("main_company_slug", "normalized_name");

-- CreateIndex
CREATE UNIQUE INDEX "products_main_company_slug_normalized_name_key" ON "products"("main_company_slug", "normalized_name");

-- CreateIndex
CREATE INDEX "product_aliases_main_company_slug_idx" ON "product_aliases"("main_company_slug");

-- CreateIndex
CREATE INDEX "product_aliases_main_company_slug_product_id_idx" ON "product_aliases"("main_company_slug", "product_id");

-- CreateIndex
CREATE UNIQUE INDEX "product_aliases_main_company_slug_normalized_name_key" ON "product_aliases"("main_company_slug", "normalized_name");
...
-- AddForeignKey
ALTER TABLE "current_account_movements" ADD CONSTRAINT "current_account_movements_document_id_fkey" FOREIGN KEY ("document_id") REFERENCES "documents"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "vat_records" ADD CONSTRAINT "vat_records_main_company_slug_fkey" FOREIGN KEY ("main_company_slug") REFERENCES "main_companies"("slug") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "vat_records" ADD CONSTRAINT "vat_records_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "companies"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "products" ADD CONSTRAINT "products_main_company_slug_fkey" FOREIGN KEY ("main_company_slug") REFERENCES "main_companies"("slug") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "product_aliases" ADD CONSTRAINT "product_aliases_main_company_slug_fkey" FOREIGN KEY ("main_company_slug") REFERENCES "main_companies"("slug") ON DELETE RESTRICT ON UPDATE CASCADE;
