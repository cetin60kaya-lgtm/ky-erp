...
export function registerAuthOwnerGuardRoutes(app: any) {
  // Normal admin kullanıcı endpointi hiçbir koşulda Süper Yönetici üretemez.
  // İkinci owner ataması yalnız KY Güvenlik yeniden doğrulamalı kritik işlem rotasına aittir.
  ...
  // Yeni bir kullanıcıyı owner rolüne yükseltmek de bu normal rota üzerinden kesin olarak yasaktır.
