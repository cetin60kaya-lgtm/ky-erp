...
const migration = fs.readFileSync(path.join(root, "migrations", "0029_accounting_document_core.sql"), "utf8");
const intelligenceMigration = fs.readFileSync(path.join(root, "migrations", "0030_accounting_intelligence_profiles.sql"), "utf8");
