...
shell.use(
  ...
  cors({
    ...
    allowHeaders: ["Accept", "Authorization", "Content-Type", "X-KYERP-Tenant-Slug", "X-KYERP-Device", "X-KYERP-Push-Device", "X-KYERP-Push-Token", "X-KYERP-Build-Agent-Token", "X-KYERP-Build-Agent"],
