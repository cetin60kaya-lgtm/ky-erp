...
const migration = readFileSync(resolve(here, "../migrations/0025_file_hub_multistorage.sql"), "utf8");
const teamMigration = readFileSync(resolve(here, "../migrations/0026_file_hub_outgoing_team_links.sql"), "utf8");
