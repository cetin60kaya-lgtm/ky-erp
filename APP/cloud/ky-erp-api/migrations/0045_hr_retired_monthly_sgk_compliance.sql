-- KY ERP / IK emekli personel + aylik SGK uyum katmani
-- Additive migration. Mevcut personel, bordro ve PDKS hareketlerini silmez/degistirmez.
...
SELECT id, main_company_id, 'NORMAL', 'SYSTEM', CURRENT_TIMESTAMP
