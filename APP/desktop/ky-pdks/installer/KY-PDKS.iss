...
[Icons]
Name: "{autoprograms}\KY ERP\KY PDKS"; Filename: "{app}\KY PDKS.exe"
Name: "{autodesktop}\KY PDKS"; Filename: "{app}\KY PDKS.exe"; Tasks: desktopicon

[Tasks]
Name: "desktopicon"; Description: "Masaüstünde KY PDKS kısayolu oluştur"; GroupDescription: "Kısayollar:"; Flags: checkedonce
...
Filename: "{sys}\sc.exe"; Parameters: "description KYERP.PDKS.Agent &quot;KY ERP PDKS cihaz toplama ve D1 senkron servisi&quot;"; Flags: runhidden waituntilterminated
...
Filename: "{app}\KY PDKS.exe"; Description: "KY PDKS uygulamasını aç"; Flags: nowait postinstall skipifsilent
