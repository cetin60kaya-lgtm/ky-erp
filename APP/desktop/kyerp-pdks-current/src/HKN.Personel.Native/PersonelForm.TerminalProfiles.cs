...
public partial class PersonelForm
{
    ...
    bool EditTerminalProfile(TerminalTransferProfile profile,out TerminalTransferProfile edited)
    {
        ...
        var editor=new TextBox{Dock=DockStyle.Fill,Multiline=true,ScrollBars=ScrollBars.Both,AcceptsTab=true,Font=new Font("Consolas",9),Text=JsonSerializer.Serialize(profile,optionsJson)};
