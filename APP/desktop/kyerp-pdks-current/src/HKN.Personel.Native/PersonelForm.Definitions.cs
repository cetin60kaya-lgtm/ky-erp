...
public partial class PersonelForm
{
    ...
    void ShowOrganizationDefinitions(string? presetLabel=null)
    {
        ...
        try{RefreshGrid();}catch(Exception ex){MessageBox.Show("Tanımlar okunamadı: "+ex.Message,"Organizasyon Tanımları",MessageBoxButtons.OK,MessageBoxIcon.Error);return;}
        dialog.ShowDialog(DialogOwner());Reload();
    }
