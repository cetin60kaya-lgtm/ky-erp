...
$MIGRATIONS = @("0028_file_hub_multistorage.sql","0029_file_hub_outgoing_team_links.sql","0030_file_hub_provider_defaults.sql","0031_file_hub_primary_location_failover.sql","0032_accounting_document_core.sql","0033_accounting_intelligence_profiles.sql","0034_accounting_document_archive_queue.sql")
...
Write-Host ""; Write-Host "============================================================" -ForegroundColor Cyan; Write-Host " KY ERP - FILE HUB + MUHASEBE HEDEFLI D1 MIGRATION" -ForegroundColor Cyan; Write-Host "============================================================" -ForegroundColor Cyan; Write-Host "Genel migration zinciri CALISMAZ. Yalniz 0028-0034 uygulanir." -ForegroundColor Yellow; Write-Host "Worker veya Pages deploy etmez." -ForegroundColor Yellow; Write-Host ""
